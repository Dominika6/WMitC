    ...
    return(
        <Navbar bg="light" expand="lg" fixed="top">
            <Container>
                <Navbar.Brand>
                    <Link to={'/'}>
                        <img src={logoText} alt="Work Management in the Company" height="45px"/>
                    </Link>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <Nav style={{display:"flex", flexDirection:"row"}} >
                    {(user && user?.result.position === 'admin') ? (
                        <>
                            ...
                            <Link to={"/createClient"} className="nav-link">Create Client</Link> &nbsp;
                            <Link to={"/getAllUsers"} className="nav-link">Users</Link> &nbsp;
                            <Link to={"/getAllClients"} className="nav-link">Clients</Link> &nbsp;
                        </>
                        ...
                        <>
                            <Link to={"/getMyTasks"} className="nav-link">Tasks</Link> &nbsp;
                            <Link to={"/getMyTeam"} className="nav-link">Team</Link> &nbsp;
                        </>
                    ): <> </> }
