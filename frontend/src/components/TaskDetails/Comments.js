...
const Comments = ({ task }) => {
    ...
    return(
        <div>
            <Typography variant="h5">Discussion</Typography><br/>
            <div>
            ...
            <div>
                <TextField fullWidth minRows={2} variant="outlined" multiline value={task_comment} onChange={(e) => setComment(e.target.value)}/><br/><br/>
